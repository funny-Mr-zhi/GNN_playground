...
"""
PEP484是python增强提案中的484号提案，全称为"Tyeping Hints"，即类型提示。
"""

from abc import abstractmethod, ABCMeta # abc是抽象基类的缩写，强制子类实现特定方法
# 抽象基类abc是一种不能直接实例化的特殊类
# abstractmethod是一个装饰器，用于声明抽象方法，子类必须实现该方法
# 指定metaclass=ABCMeta可以创建抽象基类,本质与直接集成ABC效果相同
import collections
...
# __all__定义使用from...import * 时，哪些名称会被导入
__all__ = [
